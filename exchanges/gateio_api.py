# exchanges/gateio_api.py
# Gate.io API-клієнт для мультибіржового арбітражного бота (v3.0m_05-08-25)
import ccxt
...
class GateioClient:
    ...
    def get_spot_symbols(self, min_volume=100000):
        try:
            ...
            log_info(f"Gateio: отримано {len(symbols)} spot-символів з обсягом >= {min_volume}")
            return symbols
